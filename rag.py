...
from langchain_core.runnables import RunnableConfig, RunnablePassthrough, RunnableWithMessageHistory, RunnableLambda
...
if __name__ == '__main__':
    ...
    res = RagService().chain.invoke({"input": "什么是RAG？"}, session_config)
    print(res)
